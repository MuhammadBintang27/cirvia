...
//     explanation:
//       'Pada rangkaian seri, R_total = R₁ + R₂. Dengan V = 12V dan I_target = 0.08A, maka R_total yang dibutuhkan adalah R = V/I = 12/0.08 = 150Ω. Kombinasi yang benar adalah 100Ω + 50Ω = 150Ω, sehingga arus yang mengalir I = V/R = 12/150 = 0.08A.',
...
//     correctSolution: [100, 50], // Correct answer: 100Ω + 50Ω = 150Ω → I = 12/150 = 0.08A
//   },
...
//     id: 2,
//     questionType: 'circuit',
//     title: 'Rangkaian Paralel — Mencapai Arus Maksimal',
//     description:
...
//     explanation:
//       'Pada rangkaian paralel, 1/R_total = 1/R₁ + 1/R₂. Untuk R₁=60Ω dan R₂=60Ω, maka 1/R_total = 1/60 + 1/60 = 2/60, sehingga R_total = 30Ω. Arus total I = V/R_total = 9/30 = 0.3A, yang melebihi target 0.15A.',
//     hint: 'Ingat! Pada rangkaian paralel, hambatan total LEBIH KECIL dari hambatan terkecil. Gunakan rumus 1/R_total = 1/R₁ + 1/R₂. Semakin kecil R_total, semakin besar arus yang mengalir.',
//     difficulty: 'medium',
...
//     correctSolution: [60, 60], // 1/R = 1/60 + 1/60 = 2/60 → R = 30Ω → I = 9/30 = 0.3A
//   },
...
//     id: 3,
//     questionType: 'circuit',
//     title: 'Rangkaian Seri — Kontrol Tegangan',
//     description:
...
//     explanation:
//       'Pada rangkaian seri dengan R₁=100Ω, R₂=100Ω, R₃=200Ω, R_total = 400Ω. Arus I = 15/400 = 0.0375A. Tegangan pada R₃: V₃ = I × R₃ = 0.0375 × 200 = 7.5V. Namun untuk mendapat tepat 6V pada R₃ dengan total 15V, perlu R₃ = 2/5 × R_total. Jika R₃=150Ω dan R_total=375Ω, maka V₃ = (150/375) × 15 = 6V.',
//     hint: 'Tegangan pada resistor di rangkaian seri: V_resistor = (R_resistor / R_total) × V_source. Untuk mendapat V₃ = 6V dari 15V, rasio R₃/R_total harus = 6/15 = 2/5.',
//     difficulty: 'hard',
//     circuitType: 'series',
//     voltage: 15,
//     targetVoltage: 6,
...
//     correctSolution: [75, 150, 150], // R_total = 375Ω, V₃ = (150/375) × 15 = 6V
//   },
...
//     id: 5,
//     questionType: 'circuit',
//     title: 'Rangkaian Seri Sederhana — Lampu Redup',
//     description:
...
//     explanation:
//       'Dengan target I = 0.03A dan V = 6V, maka R_total = V/I = 6/0.03 = 200Ω. Kombinasi 100Ω + 100Ω = 200Ω akan menghasilkan arus tepat 0.03A.',
...
//     correctSolution: [100, 100], // 100 + 100 = 200Ω → I = 6/200 = 0.03A
//   },
