              ...
              <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-8 min-h-96 relative overflow-hidden">
                ...
                {elements.map((element) => (
                  <div
                    ...
                    style={{
                      left: `${Math.min(
                        Math.max(element.position.x, 50),
                        90
                      )}%`,
                  ...
                  >
                    {element.type === "battery" ? (
                      <div
                        className={`w-16 h-8 rounded-md flex items-center justify-center text-white font-bold text-sm border-2 ${
                          selectedElement === element.id
                      ...
                      <div
                        className={`w-12 h-12 rounded-lg flex items-center justify-center text-white font-bold text-xs border-2 transform rotate-45 ${
                          selectedElement === element.id
                            ? "bg-yellow-500 border-yellow-600 shadow-lg"
                    ...
                    elements.map((element, index) => {
                      ...
                      return (
                        <line
                          key={`line-${element.id}`}
                          x1={`${Math.min(
                            Math.max(prevElement.position.x, 5),
                            95
                          )}%`}
                          y1={`${Math.min(
                            Math.max(prevElement.position.y, 5),
                            95
                          )}%`}
                          x2={`${Math.min(
                            Math.max(element.position.x, 5),
                            95
                          )}%`}
                          y2={`${Math.min(
                            Math.max(element.position.y, 5),
                            95
                          )}%`}
                          stroke="#374151"
                          strokeWidth="2"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="space-y-2 text-sm text-gray-600">
                        <p>
                          ✋ <strong>Telapak Terbuka:</strong> Tambah Resistor
                        </p>
                        <p>
                          👍 <strong>Jempol:</strong> Tambah Baterai
                        </p>
                        <p>
                          ✌️ <strong>Peace Sign:</strong> Hitung Rangkaian
                        </p>
                        <p>
                          ✊ <strong>Kepalan:</strong> Reset Rangkaian
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        {activeTab === "cv" && (
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-6">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Aplikasi Python CV lengkap dengan gesture detection, embedded
                langsung di platform web tanpa jendela terpisah!
              </p>
            </div>
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Jika Python server tidak bisa berjalan, gunakan versi web
                  sederhana:
                </p>
                <EmbeddedCVPracticum />
              </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b">
                      ...
                      <th className="text-center py-2 px-3 text-blue-600">
                        🤖 Python CV
                        <br />
                        <small>(Embedded)</small>
                      </th>
                      <th className="text-center py-2 px-3 text-green-600">
                        🌐 Web Version
                        <br />
                        <small>(Simple)</small>
                      </th>
                      <th className="text-center py-2 px-3 text-purple-600">
                        💻 Desktop App
                        <br />
